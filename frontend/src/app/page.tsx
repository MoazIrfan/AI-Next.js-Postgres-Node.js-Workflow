  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100">
      <div className="space-y-4 w-full max-w-2xl">
        <h1 className="text-2xl font-bold text-gray-800 text-center">Hello from Next.js 14</h1>
        <h4 className='text-1xl font-bold text-gray-400 text-center'>With Postgres database & Node.js backend</h4>
        ...
        <form onSubmit={createUser} className="p-4 bg-blue-100 rounded shadow">
          <input 
            ...
            className="mb-2 w-full p-2 border text-gray-800 border-gray-300 rounded"
          />
          <input
            placeholder="Email"
            value={newUser.email}
